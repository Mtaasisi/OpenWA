...
export const SESSION_RUNNING_STATUSES = ['initializing', 'qr_ready', 'authenticating', 'ready'] as const;

/** Session is starting but not yet connected. */
export const SESSION_CONNECTING_STATUSES = ['initializing', 'qr_ready', 'authenticating'] as const;
